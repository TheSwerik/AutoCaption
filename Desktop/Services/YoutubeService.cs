...
public static class YoutubeService
{
    ...
    )
    {
        ...
        var result = await allVideoIds.Skip(skip).SelectManyAsync(async id =>
        {
    ...
    private static async Task<List<string>> GetAllVideoIdsAsync(YouTubeVisibility[] visibilities)
    {
        ...
        if (uploadsPlaylistId is null) throw new YouTubeServiceException("Upload Playlist not found");
